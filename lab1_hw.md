...
R is a program that translates codes and is usually used for statistical work while RStudio is a GUI that is needed to work in R. GitHub is a platform that allows programmers to save their codes and share it with others.  
...
Yes, both results surprised me as they demonstrate how it is necessary to include parentheses or else you will get a completely different answer to the calculation.  
