...
```{r}
green_hair <- good_guys%>%
  filter(`Hair color`=="Green")
green_hair
```

```{r}
table(green_hair$`Hair color`)
```
```{r}
bad_green_hair <- bad_guys%>%
  filter(`Hair color`=="Green")
bad_green_hair
```
```{r}
table(bad_green_hair$`Hair color`)
```
